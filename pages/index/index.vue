<template>
	<view class="content">
		<view class="" v-for="device in devicesList" :key="device.deviceId">
			<text>{{device.name}}</text>
		</view>
		<button type="primary" @tap="startBluetoothDeviceDiscovery">startBluetoothDeviceDiscovery</button>
		<button type="primary" @tap="stopBluetoothDevicesDiscovery">stopBluetoothDevicesDiscovery</button>
		<button type="primary" @tap="onBluetoothDeviceFound">onBluetoothDeviceFound</button>
		<button type="primary" @tap="getBluetoothDevices">getBluetoothDevices</button>
	</view>
</template>
